...
public class Order {
    ...
    public String toString() {
        return "Order(id=" + this.getId() + ", restaurantId=" + this.getRestaurantId() + ", items=" + this.getItems() + ", totalPrice=" + this.getTotalPrice() + ", orderTime=" + this.getOrderTime() + ", specialNote=" + this.getSpecialNote() + ", paymentId=" + this.getPaymentId() + ", deliveryTime=" + this.getDeliveryTime() + ", userInfo=" + this.getUserInfo() + ")";
    }
}
